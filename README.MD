[![Gitlab Status](https://gitlab.com/gdraheim/git_show_bigfiles/badges/main/pipeline.svg?key_width=120&key_text=gitlab+pipeline)](https://gitlab.com/gdraheim/git_show_bigfiles)
